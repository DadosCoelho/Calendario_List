...
class_tipo = {
    # ---- ESTAÇÕES ----
    1: {"descricao": "Verão", "tipo": "estação", "meses": [1, 2, 3], "mult": 1.9},
    2: {"descricao": "Outono", "tipo": "estação", "meses": [4, 5, 6], "mult": 1.9},
    3: {"descricao": "Inverno", "tipo": "estação", "meses": [7, 8, 9], "mult": 1.8},
    4: {"descricao": "Primavera", "tipo": "estação", "meses": [10, 11, 12], "mult": 1.9},

    # ---- EVENTOS ----
    5: {"descricao": "Férias de Verão", "tipo": "evento", "meses": [1], "mult": 1.5},
    6: {"descricao": "Carnaval", "tipo": "evento", "meses": [2], "mult": 1.7},
    7: {"descricao": "Semana Santa e Páscoa", "tipo": "evento", "meses": [3], "mult": 1.5},
    8: {"descricao": "Dia das Mães", "tipo": "evento", "meses": [5], "mult": 1.9},
    9: {"descricao": "Festa Junina", "tipo": "evento", "meses": [6], "mult": 1.6},
    10: {"descricao": "Dia dos Pais", "tipo": "evento", "meses": [7], "mult": 1.5},
    11: {"descricao": "Dia das Crianças", "tipo": "evento", "meses": [10], "mult": 1.7},
    12: {"descricao": "Halloween", "tipo": "evento", "meses": [10], "mult": 1.5},
    13: {"descricao": "Natal", "tipo": "evento", "meses": [12], "mult": 1.8},
    14: {"descricao": "Réveillon", "tipo": "evento", "meses": [12], "mult": 1.7},
}
...
tabela_numeros = {
    ...
    "8": {"base_chance": 1.00, "dependencias": {"5": 14.00, "6": 14.00, "7": 14.00}, "tipo": [1, 7]},
    "9": {"base_chance": 1.50, "dependencias": {}, "tipo": [1]},
    ...
    "17": {"base_chance": 1.20, "dependencias": {"18": 18.00}, "tipo": [2, 9]},
    "18": {"base_chance": 1.00, "dependencias": {"17": 17.00}, "tipo": [2, 9]},
    ...
    "29": {"base_chance": 1.20, "dependencias": {"28": 16.00, "30": 15.00}, "tipo": [3, 10]},
    "30": {"base_chance": 1.40, "dependencias": {"29": 14.00}, "tipo": [3, 10]},
    ...
    "49": {"base_chance": 1.00, "dependencias": {"50": 14.00}, "tipo": [4, 14]},
